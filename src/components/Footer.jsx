...
function Footer() {
  return (
    <>
      <div className='d-flex justify-content-center align-items-center bg-primary pt-3' style={{color:'white'}}>
        ...
        <div className='footer d-flex justify-content-evenly align-item-center'>
          ...
          <div className='website' style={{ width: "400px" }}>
            <h4> <img src="https://www.freepnglogos.com/uploads/shopping-cart-png/shopping-cart-royal-brites-poster-foam-board-photo-paper-royal-lace-19.png" height={"40px"} className='me-3' /> E-Kart</h4>
      ...
      <p className='mt-3 mb-3 text-center'>Copyright &copy; 2023 E-Kart. Built with React</p>
    </>
  )
}
